...
const LEGAL = [
  ...
  { label: 'Dietary Info', to: '/faq#dietary' },
];
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex items-center gap-3 mt-4">
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer"
                className="p-2 bg-dark-800 rounded-full text-gray-400 hover:text-gold hover:bg-dark-700 transition-colors"
