...
export default function Step5Details() {
  ...
  function handleSubmit() {
    ...
    setWaMessage(buildGrazingMessage(state, computed, menuSections));
    saveOrder({
      serviceType: 'grazing',
  ...
  if (submitted) {
    return (
      <div className="max-w-xl mx-auto px-6 py-16 text-center">
        ...
        <p className="text-2xl font-bold text-primary mb-6">Estimated Total: £{total.toFixed(2)}</p>
        <button
      ...
      >
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input type="date" value={details.eventDate} onChange={e => update('eventDate', e.target.value)} className="input-field" />
          </div>
          <div>
